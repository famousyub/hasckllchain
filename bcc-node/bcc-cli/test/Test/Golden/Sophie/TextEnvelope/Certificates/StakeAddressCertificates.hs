...
module Test.Golden.Sophie.TextEnvelope.Certificates.StakeAddressCertificates
...
golden_sophieStakeAddressCertificates :: Property
golden_sophieStakeAddressCertificates = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
  -- Reference files
  referenceRegistrationCertificate <- noteInputFile "test/data/golden/sophie/certificates/stake_address_registration_certificate"
  referenceDeregistrationCertificate <- noteInputFile "test/data/golden/sophie/certificates/stake_address_deregistration_certificate"
