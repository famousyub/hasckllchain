...
module Test.Golden.Sophie.Genesis.KeyGenDelegate
  ( golden_sophieGenesisKeyGenDelegate
  ) where
...
golden_sophieGenesisKeyGenDelegate :: Property
golden_sophieGenesisKeyGenDelegate = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
