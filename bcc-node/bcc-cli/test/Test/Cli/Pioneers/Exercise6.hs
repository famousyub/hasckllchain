...
prop_createZeroEntropicTxOutTransaction :: Property
prop_createZeroEntropicTxOutTransaction = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
  -- Key filepaths
  ...
  void $ execBccCLI
    ...
    , "--tx-out", "addr1v9wmu83pzajplrtpsq6tsqdgwr98x888trpmah2u0ezznsge7del3 0 entropic"
    , "--fee", "1000000"
...
tests =
  H.checkSequential
    $ H.Group "Pioneers Example 6"
        [ ("prop_createZeroEntropicTxOutTransaction", prop_createZeroEntropicTxOutTransaction)
        ]
