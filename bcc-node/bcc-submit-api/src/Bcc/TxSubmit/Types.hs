...
import           Bcc.Api (AnyBccEra, AnyConsensusMode (..), Error (..), TxId)
import           Bcc.Binary (DecoderError)
import           Bcc.TxSubmit.Util (textShow)
...
data TxCmdError
  ...
  | TxCmdEraConsensusModeMismatch !AnyConsensusMode !AnyBccEra
