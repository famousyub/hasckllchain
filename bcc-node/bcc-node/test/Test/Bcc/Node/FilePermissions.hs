...
module Test.Bcc.Node.FilePermissions
  ( tests
  ) where
...
tests :: IO Bool
tests =
  Hedgehog.checkParallel $ Group "Test.Bcc.Node.FilePermissons"
#ifdef UNIX
