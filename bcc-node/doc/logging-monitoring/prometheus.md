...
Prometheus needs to be configured to monitor your Bcc Node. A minimalistic configuration file doing this could look like this:
        ...
        scrape_configs:
          - job_name: 'bcc' # To scrape data from the bcc node
            scrape_interval: 5s
            static_configs:
...
You have to replace `a.b.c.d` with the public IP-address of your Bcc Node server, which you can find on the dashboard under _IPv4 Public IP_.
