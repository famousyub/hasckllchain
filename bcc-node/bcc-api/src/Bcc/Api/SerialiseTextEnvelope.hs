...
--
module Bcc.Api.SerialiseTextEnvelope
  ( HasTextEnvelope(..)
  , TextEnvelope(..)
  , TextEnvelopeType(..)
  , TextEnvelopeDescr(..)
...
--
-- It contains a \"type\" field, e.g. \"PublicKeyCole\" or \"TxSignedSophie\"
...
--
-- For example, one might check that the type is \"TxSignedSophie\".
--
