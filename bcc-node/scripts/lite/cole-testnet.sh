...
cabal run exe:bcc-cli -- cole genesis genesis "${ARGS[@]}"

# Compute genesis hash
cabal run exe:bcc-cli -- cole genesis print-genesis-hash --genesis-json "${data_dir}/genesis/genesis.json" | tail -1 > "${data_dir}"/genesis/GENHASH
